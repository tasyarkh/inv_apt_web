	...
	<ul class="nav user-menu">
		...
		<li class="nav-item dropdown noti-dropdown">
			...
			<div class="dropdown-menu notifications">
				<div class="topnav-dropdown-header">
					...
					<a href="{{route('mark-as-read')}}" class="clear-noti">Baca Semua</a>
				</div>
									...
									<div class="media">
										...
										<div class="media-body">
											...
											<p class="noti-details">
												<span class="noti-title">{{$notification->data['product_name']}} is only {{$notification->data['quantity']}} habis.</span>
												<span>Segera update data kuantitas pembelian </span>
											</p>
		...
		<li class="nav-item dropdown has-arrow">
			...
			<div class="dropdown-menu">
				...
				@can('view-settings')<a class="dropdown-item" href="{{route('settings')}}">Pengaturan</a>@endcan
				{{-- @can('backup-app')
